      ...
      <div class="site-nav__mobile-actions">
        <button class="theme-toggle theme-toggle--mobile button button--ghost" type="button" aria-label="Activate dark theme" aria-pressed="false" data-theme-toggle>
          <span class="theme-toggle__glyph" aria-hidden="true">
            <span class="theme-toggle__sun" data-lucide="sun"></span>
            <span class="theme-toggle__moon" data-lucide="moon"></span>
          </span>
  ...
  <div class="container site-footer__inner">
    <div class="site-footer__top">
      <div class="site-footer__brand-column">
        ...
        <p class="site-footer__description">HackUnion brings developers, designers, founders, AI engineers, and creators together to build real projects, learn in public, and keep momentum alive.</p>
      ...
      <div class="site-footer__links-grid">
        <section class="site-footer__column" aria-labelledby="footer-nav-title">
          ...
          <nav class="site-footer__nav" aria-label="Footer navigation">
            <ul class="site-footer__list" data-footer-links>
              <li><a href="${depthPrefix}">Home</a></li>
              <li><a href="${depthPrefix}#manifesto">About</a></li>
              <li><a href="${depthPrefix}certificates/">Certificates</a></li>
              <li><a href="${depthPrefix}socials/">Socials</a></li>
              <li><a href="${depthPrefix}#community">Community</a></li>
              <li><a href="${depthPrefix}#final-cta">Contact</a></li>
            </ul>
          </nav>
        </section>

        <section class="site-footer__column" aria-labelledby="footer-experiences-title">
          <h2 id="footer-experiences-title" class="site-footer__title">Experiences</h2>
          <ul class="site-footer__list">
            <li><a href="${depthPrefix}#experiences">Builders Guild</a></li>
            <li><a href="${depthPrefix}#experiences">Community Meetups</a></li>
            <li><a href="${depthPrefix}#experiences">Hackathons</a></li>
            <li><a href="${depthPrefix}#experiences">OpenBuild Week</a></li>
            <li><a href="${depthPrefix}copilot-dev-days/">GitHub Copilot Dev Days</a></li>
          </ul>
        </section>
        ...
        <section class="site-footer__column" aria-labelledby="footer-resources-title">
          ...
          <ul class="site-footer__list">
            <li><a href="${depthPrefix}#community">Builder Stories</a></li>
            <li><a href="${depthPrefix}#partners">Partner Ecosystem</a></li>
            <li><a href="${depthPrefix}certificates/">Certificates</a></li>
            <li><a href="https://github.com/vasay/HU-New" target="_blank" rel="noreferrer">GitHub Repository</a></li>
            <li><a href="${depthPrefix}#final-cta">Newsletter</a></li>
          </ul>
        </section>
        ...
        <section class="site-footer__column" aria-labelledby="footer-contact-title">
          ...
          <ul class="site-footer__list site-footer__list--contact">
            ...
            <li><a href="${depthPrefix}#partners">Partner with HackUnion</a></li>
            <li><a href="${depthPrefix}#community">Volunteer with the Community</a></li>
            <li><a href="${depthPrefix}#final-cta">Request Updates</a></li>
          </ul>
        </section>
      </div>
    </div>
    ...
    <div class="site-footer__middle">
      <form class="site-footer__newsletter" data-footer-newsletter-form aria-label="Subscribe to HackUnion newsletter" novalidate>
        <div class="site-footer__newsletter-copy">
          ...
          <p class="site-footer__newsletter-text">Receive event announcements, builder stories, project launches, and community updates.</p>
        </div>
    ...
    <div class="site-footer__bottom">
      ...
      <nav class="site-footer__legal" aria-label="Legal links">
        <ul class="site-footer__legal-list">
          <li><a href="${depthPrefix}#final-cta">Privacy</a></li>
          <li><a href="${depthPrefix}#final-cta">Terms</a></li>
          <li><a href="${depthPrefix}#community">Code of Conduct</a></li>
        </ul>
      </nav>
...
<html lang="en">
  <head>
    ...
    <title>${title}</title>
    <script>
      /* Paints the opener's ink screen before any module parses, so the page
         never flashes underneath it. Self-clearing if the intro module fails
         to load, so the site always appears. */
      (function () {
        var d = document.documentElement;
        try {
          if (sessionStorage.getItem('hu-intro-seen') === '1') return;
          if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) return;
        } catch (e) { return; }
        d.classList.add('hu-intro-armed');
        setTimeout(function () { d.classList.remove('hu-intro-armed'); }, 2500);
      })();
    </script>
  </head>
  <body
      ...
      <main id="main-content" class="site-main blogs-main">
        <section class="hero section blogs-hero" aria-labelledby="blogs-hero-title">
          ...
          <div class="container container--wide blogs-hero__inner">
            <div class="blogs-hero__intro stack stack--lg" data-animate="fade-up">
              ...
              <p class="blogs-hero__meta" aria-label="Blog publication metadata">
