...
const normalizeBlogAssetPath = (assetPath) => String(assetPath)
  .replace(/\\/g, '/')
  .replace(/^\.\//, '')
  .replace(/^\//, '')
  .replace(/^public\//i, '');
...
<article class="card blog-featured-card">
  <a class="blog-featured-card__media blog-image-holder" style="--blog-image-ratio: 16 / 9; --blog-image-position: ${escapeHtml(post.coverImagePosition || 'center')}; --blog-image-fit: ${escapeHtml(post.coverImageFit || 'cover')};" href="./${post.slug}/" aria-label="Read featured article: ${escapeHtml(post.title)}">
...
<article class="card blog-grid-card" data-hover="card">
  <a class="blog-grid-card__media blog-image-holder" style="--blog-image-ratio: 16 / 9; --blog-image-position: ${escapeHtml(post.coverImagePosition || 'center')}; --blog-image-fit: ${escapeHtml(post.coverImageFit || 'cover')};" href="./${post.slug}/" aria-label="Read article: ${escapeHtml(post.title)}">
