...
const featureLoaders = [
  ...
  {
    selector: '[data-about-hero-carousel]',
    importer: () => import('./modules/about-hero-carousel.js'),
    exportName: 'initAboutHeroCarousel'
  },
  {
    selector: '[data-footer-wordmark]',
    importer: () => import('./modules/footer-wordmark.js'),
    exportName: 'initFooterWordmark'
  },
  {
